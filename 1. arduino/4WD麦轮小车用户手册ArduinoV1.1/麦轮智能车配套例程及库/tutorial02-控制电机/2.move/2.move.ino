...
void loop() {
  ...
  setMotor(0, 0, 0, 0);
  delay(2000);
  setMotor(100, -100, 100, -100);   //右旋转
  delay(1000);
  setMotor(-100, 100, -100, 100);   //左旋转
  delay(1000);
  setMotor(0, 0, 0, 0);
  delay(2000);
  setMotor(100, -100, -100, 100);   //右移
  delay(1000);
  setMotor(-100, 100, 100, -100);   //左移
  delay(1000);
  setMotor(0, 0, 0, 0);
  delay(2000);
  setMotor(100, 0, 0, 100);   //右前移
  delay(1000);
  setMotor(0, 100, 100, 0);   //左前移
  delay(1000);
  setMotor(0, 0, 0, 0);
  delay(2000);
  setMotor(0, -100, -100, 0);   //右后移
  delay(1000);
  setMotor(-100, 0, 0, -100);   //左后移
  delay(1000);
  setMotor(0, 0, 0, 0);
  delay(2000);
}
