...
while 1:
    ...
    data_write = [SCS_MOVING_ACC] 
    data_write[1:2] = [SCS_LOBYTE(scs_goal_position[index]), SCS_HIBYTE(scs_goal_position[index])]
    data_write[3:4] = [0, 0]
    data_write[5:6] = [SCS_LOBYTE(SCS_MOVING_SPEED), SCS_HIBYTE(SCS_MOVING_SPEED)]
    #print(data_write)
    scs_comm_result, scs_error = packetHandler.writeTxRx(portHandler, SCS_ID, ADDR_SCS_GOAL_ACC, 7, data_write)
